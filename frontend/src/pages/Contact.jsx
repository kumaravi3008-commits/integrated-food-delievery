...
const Contact = () => {
  ...
  return (
    <div className="container my-24 mx-auto md:px-6">
      <h1 className="text-center text-orange-400 font-bold text-3xl lg:text-4xl mb-6 px-4 lg:px-0">
        Contact with Dream.
      </h1>
          ...
          <div className="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
            <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
              <div className="mx-auto mb-12 text-center lg:mb-0">
                <FaGlobeAmericas className="mx-auto mb-6 h-8 w-8 text-orange-500 text-primary" />
                <h6 className="font-medium">Banglore</h6>
              </div>
              <div className="mx-auto mb-12 text-center lg:mb-0">
                <SlLocationPin className="mx-auto mb-6 h-8 w-8 text-orange-500 text-primary" />
                <h6 className="font-medium">Banglore, 94123456</h6>
              </div>
              <div className="mx-auto mb-6 text-center md:mb-0">
                <FaPhoneAlt className="mx-auto mb-6 h-8 w-8 text-orange-500 text-primary" />

                <h6 className="font-medium">+ 01 234 567 89</h6>
              </div>
              <div className="mx-auto text-center">
                <FaMoneyBills className="mx-auto mb-6 h-8 w-8 text-orange-500 text-primary" />
