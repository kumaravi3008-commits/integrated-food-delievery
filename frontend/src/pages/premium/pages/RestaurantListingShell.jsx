...
export default function RestaurantListingShell() {
  ...
  const params = useMemo(() => {
    ...
    // Backend may not support `open`; filtering is client-side for safety.
    // Nearby/open can be handled later.
    return p;
  }, [query]);
      ...
      <div className="w-full flex flex-col gap-5">
        ...
        {!loading && filtered.length === 0 && !error ? (
          <PremiumCard className="p-6">
            ...
            <div className="mt-2 text-sm text-white/70">Try searching for another restaurant or cuisine.</div>
          </PremiumCard>
        ) : null}
