...
const Footer = () => {
  return (
    <footer className="footer py-10 px-8 sm:px-10 md:px-16 lg:px-16 xl:px-22 font-medium border-t bg-black text-base-content">
      <aside className="lg:px-4">
        <Link to="/" className="text-2xl text-orange-700 font-semibold">
          Dine Express
        </Link>
