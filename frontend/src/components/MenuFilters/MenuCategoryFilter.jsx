const MenuCategoryFilter = ({
  ...
  return (
    <div className="collapse collapse-arrow border-b border-gray-300 rounded-none">
      <input type="checkbox" />
      <div className="collapse-title px-0 text-xl font-bold text-orange-600">
        Category
      </div>
          ...
          <div key={category} className="form-control">
            <label className="label cursor-pointer justify-start gap-3">
              <input
                ...
                className="checkbox checkbox-primary checkbox-sm border-gray-400"
                onChange={() => toggleCategory(category)}
              />
              <span className="label-text text-orange-400 font-medium">
                {category}
              </span>
            </label>
          </div>
