        ...
        <div className="max-w-[700px] flex flex-col justify-center">
          ...
          <div className="flex flex-col gap-10 mt-10">
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <Link
                to="/home"
                className="min-w-[150px] h-12 rounded-full bg-white/10 border border-white/20 hover:bg-white/15 text-white text-sm font-bold uppercase tracking-[0.08em] whitespace-nowrap transition-colors flex items-center justify-center px-8"
              >
