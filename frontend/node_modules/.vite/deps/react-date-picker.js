...
// node_modules/react-date-picker/node_modules/clsx/dist/clsx.mjs
function r(e) {
  var t, f, n = "";
...
function Tile(props) {
  ...
  return import_react4.default.createElement(
    "button",
    { className: clsx_default2(classes, tileClassName), disabled: minDate && minDateTransform(minDate) > date || maxDate && maxDateTransform(maxDate) < date || tileDisabled && tileDisabled({ activeStartDate, date, view }), onClick: onClick ? function(event) {
...
function Month(_a3) {
  ...
  var date = otherProps.date, locale = otherProps.locale;
  return import_react11.default.createElement(Tile, __assign8({}, otherProps, { classes: __spreadArray4(__spreadArray4([], classes, true), [className4], false), formatAbbr: formatMonthYear2, maxDateTransform: getMonthEnd, minDateTransform: getMonthStart, view: "year" }), formatMonth3(locale, date));
}
...
function Weekdays(props) {
  ...
  for (var weekday = 1; weekday <= 7; weekday += 1) {
    ...
    weekdays.push(import_react16.default.createElement(
      "div",
      { key: weekday, className: clsx_default2(weekdayClassName, isCurrentDayOfWeek(weekdayDate) && "".concat(weekdayClassName, "--current"), isWeekend(weekdayDate, calendarType) && "".concat(weekdayClassName, "--weekend")) },
...
var MonthView = function MonthView2(props) {
  ...
  return import_react19.default.createElement(
    "div",
    { className: clsx_default2(className8, showWeekNumbers ? "".concat(className8, "--weekNumbers") : "") },
...
var Calendar = (0, import_react20.forwardRef)(function Calendar2(props, ref) {
  ...
  return import_react20.default.createElement(
    "div",
    { className: clsx_default2(baseClassName, selectRange && valueArray.length === 1 && "".concat(baseClassName, "--selectRange"), showDoubleView && "".concat(baseClassName, "--doubleView"), className8), ref: inputRef },
    renderNavigation(),
...
function MonthSelect(_a3) {
  ...
  var maxMonth = safeMin(12, maxDate && isSameYear(maxDate) && getMonthHuman(maxDate));
  var minMonth = safeMax(1, minDate && isSameYear(minDate) && getMonthHuman(minDate));
  var dates = __spreadArray5([], Array(12), true).map(function(el, index) {
...
var allValueTypes2 = __spreadArray6(__spreadArray6([], allViews3.slice(1), true), ["day"], false);
...
var allValueTypes3 = __spreadArray7(__spreadArray7([], allViews4.slice(1), true), ["day"], false);
var isValueType = import_prop_types4.default.oneOf(allValueTypes3);
...
var isRef2 = import_prop_types4.default.oneOfType([
  import_prop_types4.default.func,
  import_prop_types4.default.exact({
    current: import_prop_types4.default.any
  })
]);
var rangeOf2 = function(type) {
  return import_prop_types4.default.arrayOf(type);
};
...
var isValue3 = import_prop_types5.default.oneOfType([import_prop_types5.default.string, import_prop_types5.default.instanceOf(Date)]);
var isValueOrValueArray2 = import_prop_types5.default.oneOfType([isValue3, rangeOf2(isValue3)]);
DatePicker.propTypes = {
  autoFocus: import_prop_types5.default.bool,
  calendarAriaLabel: import_prop_types5.default.string,
  calendarClassName: import_prop_types5.default.oneOfType([import_prop_types5.default.string, import_prop_types5.default.arrayOf(import_prop_types5.default.string)]),
  calendarIcon: import_prop_types5.default.oneOfType([import_prop_types5.default.node, import_prop_types5.default.func]),
  ...
  clearAriaLabel: import_prop_types5.default.string,
  clearIcon: import_prop_types5.default.oneOfType([import_prop_types5.default.node, import_prop_types5.default.func]),
  closeCalendar: import_prop_types5.default.bool,
  "data-testid": import_prop_types5.default.string,
  dayAriaLabel: import_prop_types5.default.string,
  dayPlaceholder: import_prop_types5.default.string,
  disableCalendar: import_prop_types5.default.bool,
  ...
  maxDate: isMaxDate3,
  maxDetail: import_prop_types5.default.oneOf(allViews5),
  minDate: isMinDate3,
  monthAriaLabel: import_prop_types5.default.string,
  monthPlaceholder: import_prop_types5.default.string,
  name: import_prop_types5.default.string,
  nativeInputAriaLabel: import_prop_types5.default.string,
  onCalendarClose: import_prop_types5.default.func,
  onCalendarOpen: import_prop_types5.default.func,
  onChange: import_prop_types5.default.func,
  onFocus: import_prop_types5.default.func,
  openCalendarOnFocus: import_prop_types5.default.bool,
  ...
  yearAriaLabel: import_prop_types5.default.string,
  yearPlaceholder: import_prop_types5.default.string
};
if (isBrowser2) {
  DatePicker.propTypes.portalContainer = import_prop_types5.default.instanceOf(HTMLElement);
}
