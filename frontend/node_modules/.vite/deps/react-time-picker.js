...
// node_modules/react-time-picker/node_modules/clsx/dist/clsx.mjs
function r(e) {
  var t, f, n = "";
...
// node_modules/react-clock/node_modules/clsx/dist/clsx.mjs
function r2(e) {
  var t, f, n = "";
  if ("string" == typeof e || "number" == typeof e)
    n += e;
...
var Clock = function Clock2(_a) {
  ...
  return import_react5.default.createElement(
    "time",
    { className: clsx_default2("react-clock", className), dateTime: value instanceof Date ? value.toISOString() : value || void 0, style: {
      width: size,
      height: size
    } },
    renderFace(),
...
var esm_default4 = Clock_default;
...
function Divider(_a) {
  ...
  return import_react6.default.createElement("span", { className: "react-time-picker__inputGroup__divider" }, children);
}
...
function Input(_a) {
  ...
  return import_react7.default.createElement(
    ...
    null,
    hasLeadingZero ? import_react7.default.createElement("span", { className: "".concat(className, "__leadingZero") }, "0") : null,
    import_react7.default.createElement("input", { "aria-label": ariaLabel, autoComplete: "off", autoFocus, className: clsx_default("".concat(className, "__input"), "".concat(className, "__").concat(nameForClass || name), hasLeadingZero && "".concat(className, "__input--hasLeadingZero")), "data-input": "true", disabled, inputMode: "numeric", max, min, name, onChange, onFocus, onKeyDown, onKeyPress: makeOnKeyPress(maxLength), onKeyUp: function(event) {
...
function Hour12Input(_a) {
  ...
  return import_react8.default.createElement(Input, __assign3({ max: maxHour, min: minHour, name: "hour12", nameForClass: "hour", value: value12 }, otherProps));
}
...
function Hour24Input(_a) {
  ...
  return import_react9.default.createElement(Input, __assign4({ max: maxHour, min: minHour, name: "hour24", nameForClass: "hour" }, otherProps));
}
...
function MinuteInput(_a) {
  ...
  return import_react10.default.createElement(Input, __assign5({ max: maxMinute, min: minMinute, name: "minute", showLeadingZeros }, otherProps));
}
...
function SecondInput(_a) {
  ...
  return import_react11.default.createElement(Input, __assign6({ max: maxSecond, min: minSecond, name: "second", showLeadingZeros }, otherProps));
}
...
function NativeInput(_a) {
  ...
  return import_react12.default.createElement("input", { "aria-label": ariaLabel, disabled, hidden: true, max: maxTime ? nativeValueParser(maxTime) : void 0, min: minTime ? nativeValueParser(minTime) : void 0, name, onChange, onFocus: stopPropagation, required, step, style: {
    visibility: "hidden",
    position: "absolute",
    zIndex: "-999"
...
function AmPm(_a) {
  ...
  return import_react13.default.createElement(
    ...
    !value && import_react13.default.createElement("option", { value: "" }, "--"),
    import_react13.default.createElement("option", { disabled: amDisabled, value: "am" }, amLabel),
    import_react13.default.createElement("option", { disabled: pmDisabled, value: "pm" }, pmLabel)
  );
}
...
function renderCustomInputs(placeholder, elementFunctions, allowMultipleInstances) {
  ...
  return placeholder.split(pattern).reduce(function(arr, element, index) {
    ...
    import_react14.default.createElement(Divider, { key: "separator_".concat(index) }, element);
...
function TimeInput(_a) {
  ...
  var _e = (0, import_react14.useState)(null), amPm = _e[0], setAmPm = _e[1];
  var _f = (0, import_react14.useState)(null), hour = _f[0], setHour = _f[1];
  var _g = (0, import_react14.useState)(null), minute = _g[0], setMinute = _g[1];
  var _h = (0, import_react14.useState)(null), second = _h[0], setSecond = _h[1];
  var _j = (0, import_react14.useState)(null), value = _j[0], setValue = _j[1];
  var amPmInput = (0, import_react14.useRef)(null);
  var hour12Input = (0, import_react14.useRef)(null);
  var hour24Input = (0, import_react14.useRef)(null);
  var minuteInput = (0, import_react14.useRef)(null);
  var secondInput = (0, import_react14.useRef)(null);
  var _k = (0, import_react14.useState)(isClockOpenProps), isClockOpen = _k[0], setIsClockOpen = _k[1];
  var lastPressedKey = (0, import_react14.useRef)();
  ...
  function renderHour12(currentMatch, index) {
    ...
    return import_react14.default.createElement(Hour12Input, __assign7({ key: "hour12" }, commonInputProps, {
      amPm,
  ...
  function renderHour24(currentMatch, index) {
    ...
    var showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
    return import_react14.default.createElement(Hour24Input, __assign7({ key: "hour24" }, commonInputProps, {
      ariaLabel: hourAriaLabel,
      // eslint-disable-next-line jsx-a11y/no-autofocus
      autoFocus: index === 0 && autoFocus,
  ...
  function renderMinute(currentMatch, index) {
    ...
    var showLeadingZeros = currentMatch ? currentMatch.length === 2 : false;
    return import_react14.default.createElement(MinuteInput, __assign7({ key: "minute" }, commonInputProps, {
  ...
  function renderSecond(currentMatch, index) {
    ...
    return import_react14.default.createElement(SecondInput, __assign7({ key: "second" }, commonInputProps, {
  ...
  function renderAmPm(currentMatch, index) {
    return import_react14.default.createElement(AmPm, __assign7({ key: "ampm" }, commonInputProps, {
  ...
  function renderNativeInput() {
    return import_react14.default.createElement(NativeInput, { key: "time", ariaLabel: nativeInputAriaLabel, disabled, maxTime, minTime, name, onChange: onChangeNative, required, value, valueType });
  }
  return (
...
var allValueTypes = __spreadArray2([], allViews2, true);
...
var isValueType = import_prop_types2.default.oneOf(allValueTypes);
...
var ClockIcon = import_react15.default.createElement(
  "svg",
  __assign8({}, iconProps, { className: "".concat(baseClassName, "__clock-button__icon ").concat(baseClassName, "__button__icon"), fill: "none" }),
  import_react15.default.createElement("circle", { cx: "9.5", cy: "9.5", r: "7.5" }),
  import_react15.default.createElement("path", { d: "M9.5 4.5 v5 h4" })
);
var ClearIcon = import_react15.default.createElement(
  "svg",
  __assign8({}, iconProps, { className: "".concat(baseClassName, "__clear-button__icon ").concat(baseClassName, "__button__icon") }),
  import_react15.default.createElement("line", { x1: "4", x2: "15", y1: "4", y2: "15" }),
  import_react15.default.createElement("line", { x1: "15", x2: "4", y1: "4", y2: "15" })
);
var TimePicker = function TimePicker2(props) {
  ...
  var _h = (0, import_react15.useState)(isOpenProps), isOpen = _h[0], setIsOpen = _h[1];
  var wrapper = (0, import_react15.useRef)(null);
  var clockWrapper = (0, import_react15.useRef)(null);
  ...
  var closeClock = (0, import_react15.useCallback)(function(_a2) {
    var reason = _a2.reason;
    if (shouldCloseClock) {
  ...
  var onKeyDown = (0, import_react15.useCallback)(function(event) {
    if (event.key === "Escape") {
  ...
  var onOutsideAction = (0, import_react15.useCallback)(function(event) {
  ...
  var handleOutsideActionListeners = (0, import_react15.useCallback)(function(shouldListen) {
  ...
  function renderInputs() {
    ...
    return import_react15.default.createElement(
      ...
      import_react15.default.createElement(TimeInput, __assign8({}, ariaLabelProps, placeholderProps, {
        // eslint-disable-next-line jsx-a11y/no-autofocus
        autoFocus,
      ...
      clearIcon !== null && import_react15.default.createElement("button", { "aria-label": clearAriaLabel, className: "".concat(baseClassName, "__clear-button ").concat(baseClassName, "__button"), disabled, onClick: clear, onFocus: stopPropagation, type: "button" }, typeof clearIcon === "function" ? import_react15.default.createElement(clearIcon) : clearIcon),
      clockIcon !== null && !disableClock && import_react15.default.createElement("button", { "aria-label": clockAriaLabel, className: "".concat(baseClassName, "__clock-button ").concat(baseClassName, "__button"), disabled, onClick: toggleClock, onFocus: stopPropagation, type: "button" }, typeof clockIcon === "function" ? import_react15.default.createElement(clockIcon) : clockIcon)
    );
  }
  function renderClock() {
    ...
    var clockClassName = props.clockClassName, timePickerClassName = props.className, onChangeProps2 = props.onChange, portalContainer = props.portalContainer, value2 = props.value, clockProps = __rest6(props, ["clockClassName", "className", "onChange", "portalContainer", "value"]);
    ...
    var clock = import_react15.default.createElement(esm_default4, __assign8({ className: clockClassName, value: valueFrom }, clockProps));
    return portalContainer ? (0, import_react_dom.createPortal)(import_react15.default.createElement("div", { ref: clockWrapper, className: classNames }, clock), portalContainer) : import_react15.default.createElement(
      esm_default2,
      null,
      import_react15.default.createElement("div", { ref: function(ref) {
        if (ref && !isOpen) {
  ...
  var eventProps = (0, import_react15.useMemo)(function() {
    return makeEventProps(otherProps);
  }, [otherProps]);
  return import_react15.default.createElement(
    "div",
    __assign8({ className: clsx_default(baseClassName, "".concat(baseClassName, "--").concat(isOpen ? "open" : "closed"), "".concat(baseClassName, "--").concat(disabled ? "disabled" : "enabled"), className), "data-testid": dataTestid, id }, eventProps, { onFocus: onFocus2, ref: wrapper }),
    renderInputs(),
    renderClock()
  );
};
var isValue = import_prop_types3.default.oneOfType([isTime, import_prop_types3.default.instanceOf(Date)]);
var isValueOrValueArray = import_prop_types3.default.oneOfType([isValue, rangeOf(isValue)]);
TimePicker.propTypes = {
  amPmAriaLabel: import_prop_types3.default.string,
  ...
  clockAriaLabel: import_prop_types3.default.string,
  clockClassName: import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.arrayOf(import_prop_types3.default.string)]),
  clockIcon: import_prop_types3.default.oneOfType([import_prop_types3.default.node, import_prop_types3.default.func]),
  closeClock: import_prop_types3.default.bool,
  "data-testid": import_prop_types3.default.string,
  disableClock: import_prop_types3.default.bool,
  disabled: import_prop_types3.default.bool,
  format: import_prop_types3.default.string,
  hourAriaLabel: import_prop_types3.default.string,
  hourPlaceholder: import_prop_types3.default.string,
  ...
  maxTime: isTime,
  minTime: isTime,
  minuteAriaLabel: import_prop_types3.default.string,
  minutePlaceholder: import_prop_types3.default.string,
  name: import_prop_types3.default.string,
  nativeInputAriaLabel: import_prop_types3.default.string,
  onChange: import_prop_types3.default.func,
  onClockClose: import_prop_types3.default.func,
  onClockOpen: import_prop_types3.default.func,
  onFocus: import_prop_types3.default.func,
  openClockOnFocus: import_prop_types3.default.bool,
  required: import_prop_types3.default.bool,
  secondAriaLabel: import_prop_types3.default.string,
  secondPlaceholder: import_prop_types3.default.string,
  value: isValueOrValueArray
};
if (isBrowser2) {
  TimePicker.propTypes.portalContainer = import_prop_types3.default.instanceOf(HTMLElement);
}
